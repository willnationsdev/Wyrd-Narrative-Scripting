...
/* package Wyrd-0.1.0.0 */
#define VERSION_Wyrd "0.1.0.0"
#define MIN_VERSION_Wyrd(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "Wyrd-0.1.0.0-4JCULo2kQf76e3ZuwFNnR0"

#define CURRENT_PACKAGE_KEY "Wyrd-0.1.0.0-4JCULo2kQf76e3ZuwFNnR0"
